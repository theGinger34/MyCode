package com.example.favoritefeedsfragments
...
import com.example.favoritefeedsfragments.databinding.FragmentFeedsBinding
...
class FeedsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        savedFeeds = requireActivity().getSharedPreferences("feeds", Context.MODE_PRIVATE)
